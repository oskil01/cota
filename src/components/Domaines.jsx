...
const Domaines = () => {
  ...
  // ✅ Gestion du carrousel d’arrière-plan
  ...
  return (
    ...
    >
      {/* === ARRIÈRE-PLAN AVEC CARROUSEL + PARALLAX === */}
      <div className="absolute inset-0 z-0">
        ...
        {/* Overlay dynamique (dégradé sombre avec reflets) */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div
          className="bg-white/10 rounded-2xl md:rounded-3xl shadow-lg backdrop-blur-md p-6 sm:p-8 mb-12 md:mb-16 border border-white/20"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          {domaines
            .filter((ser) => ser.id === activeDomaine)
            .map((ser) => (
              <div
                key={ser.id}
                className="flex flex-col lg:flex-row gap-6 md:gap-10"
              >
                <div className="flex-1">
                  <div
                    className="flex items-center gap-3 sm:gap-4 sm:mb-6"
                    data-aos="fade-right"
                    data-aos-delay="300"
                  >
                    <div
                      className={`w-12 h-12 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center ${ser.color} bg-opacity-20`}
                    >
                  ...
                  <p
                    className="text-base sm:text-lg text-gray-100 mb-4 sm:mb-6 leading-relaxed"
                    data-aos="fade-right"
                    data-aos-delay="350"
                  >
                    {ser.desc}
                ...
                >
                  <div className="w-full h-60 sm:h-72 md:h-80 overflow-hidden shadow-lg rounded-xl md:rounded-2xl">
                    <img
                      src={typeof ser.image === "string" ? ser.image : ser.image.src}
                      alt={ser.title}
        ...
        >
          <a
            href="/domaines"
            className="bg-[#006176] hover:bg-[#00AB9A] text-white px-8 py-3 rounded-full text-sm sm:text-base font-medium shadow-md hover:shadow-lg flex items-center gap-2 transition-all"
          >
